            ...
            <div className="md:flex flex-wrap justify-center gap-20">
              <div className="text-center md:space-y-16 w-full h-full md:w-auto">
                <span>
                  <img
                    className="mx-auto"
                    src="https://animares.com/clickandbuilds/ANIMARES3DmedicalanimationIARIMRIVR/wp-content/uploads/2016/05/Cube04.png"
                    alt=""
                  />
                </span>
              ...
              <div className="md:text-center  md:space-y-16  w-full md:w-auto">
                <span>
                  <img
                    className="mx-auto"
                    src="https://animares.com/clickandbuilds/ANIMARES3DmedicalanimationIARIMRIVR/wp-content/uploads/2016/05/Mobile03.png"
                    alt=""
                  />
                </span>
                <p className="md:text-2xl  font-bold tracking-wide">
              ...
              <div className="text-center  md:space-y-16  w-full md:w-auto ">
                <span>
                  <img
                    className="mx-auto"
                    src="https://animares.com/clickandbuilds/ANIMARES3DmedicalanimationIARIMRIVR/wp-content/uploads/2016/05/Hololens03.png"
                    alt=""
                  />
                </span>
                <p className="md:text-2xl  font-bold tracking-wide">
              ...
              <div className="text-center  md:space-y-16  w-full md:w-auto ">
                <span>
                  <img
                    className="mx-auto"
                    src="https://animares.com/clickandbuilds/ANIMARES3DmedicalanimationIARIMRIVR/wp-content/uploads/2016/05/VR03.png"
                    alt=""
                  />
                </span>
                <p className="md:text-2xl  font-bold tracking-wide">
